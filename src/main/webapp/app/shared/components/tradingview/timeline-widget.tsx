...
const defaultProps: ITimelineWidgetProps = {
  symbol: "TSLA",
  width: "480",
  height: "830",
  autosize: false,
 ...
 * @param props {@link ITimelineWidgetProps}
 */
export const TimelineWidget = (props: ITimelineWidgetProps) => {
...
TimelineWidget.defaultProps = defaultProps;
