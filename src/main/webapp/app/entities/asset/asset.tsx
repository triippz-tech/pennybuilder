            ...
            <tbody>
              {assetList.map((asset, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{asset.name}</td>
                  <td>{asset.symbol}</td>
                  <td>{asset.createdDate ? <TextFormat type="date" value={asset.createdDate} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{asset.updatedDate ? <TextFormat type="date" value={asset.updatedDate} format={APP_DATE_FORMAT} /> : null}</td>
