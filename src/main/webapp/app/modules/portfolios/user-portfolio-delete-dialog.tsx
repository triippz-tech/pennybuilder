...
import { getEntity, deleteEntity } from 'app/entities/portfolio/portfolio.reducer';

export interface IUserPortfolioDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export const UserPortfolioDeleteDialog = (props: IUserPortfolioDeleteDialogProps) => {
  useEffect(() => {
...
export default connect(mapStateToProps, mapDispatchToProps)(UserPortfolioDeleteDialog);
