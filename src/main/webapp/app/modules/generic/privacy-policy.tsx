...
export const PrivacyPolicy = () => (
  <>
    <h1>Privacy Policy for PennyBuilder</h1>

    <p>At PennyBuilder, accessible from PennyBuilder.io, one of our main priorities is the privacy of our visitors. This
      Privacy Policy document contains types of information that is collected and recorded by PennyBuilder and how we
      use it.</p>
    ...
    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
      to the information that they shared and/or collect in PennyBuilder. This policy is not applicable to any
    ...
    <p>PennyBuilder follows a standard procedure of using log files. These files log visitors when they visit websites.
    ...
    <p>Like any other website, PennyBuilder uses `&quot;`cookies`&quot;`. These cookies are used to store information including
    ...
    <p>For more general information on cookies, please read <a
      href="https://www.privacypolicyonline.com/what-are-cookies/">`&ldquo;`What Are Cookies`&ldquo;` from Cookie Consent</a>.</p>
    ...
    <p>You may consult this list to find the Privacy Policy for each of the advertising partners of PennyBuilder.</p>

    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
      their respective advertisements and links that appear on PennyBuilder, which are sent directly to users`&quot;` browser.
    ...
    <p>Note that PennyBuilder has no access to or control over these cookies that are used by third-party
      advertisers.</p>

    <h2>Third Party Privacy Policies</h2>

    <p>PennyBuilder`&quot;`s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
    ...
    <p>PennyBuilder does not knowingly collect any Personal Identifiable Information from children under the age of 13.
