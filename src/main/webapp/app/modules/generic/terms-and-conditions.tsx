...
export const ToCPage = () => (
  <>
    ...
    <p>Unless otherwise stated, PennyBuilder and/or its licensors own the intellectual property rights for all material
      on PennyBuilder. All intellectual property rights are reserved. You may access this from PennyBuilder for your own
      personal use subjected to restrictions set in these terms and conditions.</p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from PennyBuilder</li>
      <li>Sell, rent or sub-license material from PennyBuilder</li>
      <li>Reproduce, duplicate or copy material from PennyBuilder</li>
      <li>Redistribute content from PennyBuilder</li>
    </ul>

    <p>This Agreement shall begin on the date hereof.</p>

    <p>Parts of this website may offer an opportunity for users to post and exchange opinions and information in certain
      areas of the website. PennyBuilder does not filter, edit, publish or review Comments prior to their presence on
      the website. Comments do not reflect the views and opinions of PennyBuilder,its agents and/or affiliates. Comments
      reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
      applicable laws, PennyBuilder shall not be liable for the Comments or for any liability, damages or expenses
      caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
      website. PennyBuilder shall not be liable for any monetary losses/gains a user of this site may incur.</p>

    <p>PennyBuilder reserves the right to monitor all Comments and to remove any Comments which can be considered
    ...
    <p>You hereby grant PennyBuilder a non-exclusive license to use, reproduce, edit and authorize others to use,
    ...
    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
      ...
      with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of PennyBuilder; and
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
      must inform us by sending an e-mail to PennyBuilder. Please include your name, your organization name, contact
