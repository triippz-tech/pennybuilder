package com.triippztech.pennybuilder.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.triippztech.pennybuilder.IntegrationTest;
import com.triippztech.pennybuilder.repository.timezone.DateTimeWrapper;
import com.triippztech.pennybuilder.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM pb_date_time_wrapper where id=%d", fieldName, id);
    }
